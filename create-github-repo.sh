...
# get script location (https://stackoverflow.com/questions/59895/how-do-i-get-the-directory-where-a-bash-script-is-located-from-within-the-script)
...
# ensure directory doesn't already exist
    ...
    echo "Error: A directory at \"$1\" already exists. Exiting."
    exit 1 
else
